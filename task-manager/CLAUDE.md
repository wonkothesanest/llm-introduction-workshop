...
When adding features (like priority in Exercise 2):
...
*This documentation reflects the workshop starting state. Update as you complete exercises and add features.*
